#ifndef UNIVERSAL_PARTICLES_UNLIT_DISTORTED_FORWARD_PASS_INCLUDED
#define UNIVERSAL_PARTICLES_UNLIT_DISTORTED_FORWARD_PASS_INCLUDED
...
half4 fragParticleUnlit(VaryingsParticle input) : SV_Target
{
    ...
    particleParams.uv += float2(noise(input.positionWS.xyz * 3.0), noise(input.positionWS.xyz * 3.0)) * 0.1;
...
#endif // UNIVERSAL_PARTICLES_UNLIT_DISTORTED_FORWARD_PASS_INCLUDED
